...
def annoter_dataset():
    ...
    nom_modele = "gemini-3.5-flash-lite" # ou gemini-3.8-flash ou gemini-3.7-flash ou gemini-3.6-flash ou gemini-3.5-flash-lite
    ...
    for i in range(index_depart, len(dataset_valide), TAILLE_LOT):
        ...
        for tentative in range(1, MAX_RETRIES + 1):
            try:
                ...
                time.sleep(15 * tentative)  # Respect du quota 5 RPM
                succes = True
                ...
                if tentative < MAX_RETRIES:
                    print(f"Attente de {15 * tentative} secondes avant la tentative {tentative + 1}...")
